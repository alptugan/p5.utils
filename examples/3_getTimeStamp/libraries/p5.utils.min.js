(function (root, factory) {
    ...
    var rulerLineY;
    var rulerInfo;
    const p5rulersize = 20;                         // Default ruler width
    const p5rulerInfoOpacity = 0.2;                 // Pixel information text color
    const p5rulerBgColor = "rgba(30,30,30,1)";      // Ruler Bg color
    const p5rulerTxtColor = "rgba(150,150,150,1)";  // Ruler Text color
    const p5rulerInfoColor = "rgba(30,30,30,1)";    // Ruler info text color
    const p5rulerTickColor = "rgba(255,0,0,1)";     // Ticker marks color on the ruler
    ...
    p5.Utils.prototype.debug = function (_itemName) {
        if (!document.getElementsByClassName("debug")[0]) {
            ...
            debug.style.background = "rgba(255,255,255,0.5)";
    ...
    /**
     * @method arrayResize Resizes an array. Similar to vector resize in C++
     * @param {Number[]|String[]|Boolean[]} _arr The array to be resized
     * @param {Number} _newSize The new size of the array
     * @param {Number|String|Boolean} [_defaultValue=0] Default value for all members of the array. By default it's 0.
     ...
     * print(arr);
     */
    p5.Utils.prototype.arrayResize = function (_arr, _newSize, _defaultValue = 0) {
        while (_newSize > _arr.length)
            _arr.push(_defaultValue);
        _arr.length = _newSize;
    ...
    /**
     * @method beginShadow
     * @description Creates shadow effect usign drawing context. Must be used with {@link endShadow} method. See examples for how to use it.
    ...
    /**
     * @description Stops shadow effect for the following graphics on the canvas. For example usage {@link beginShadow} page.
     * @method endShadow
     * @see For example usage {@link beginShadow} page.
     */
     ...
     * @param {p5.Color[]|Number[]|String[]} _colorsArr - List of colors in the gradient fill. 
    ...
    */
    p5.Utils.prototype.beginLinearGradient = function (_colorsArr, _startX, _startY, _endX, _endY, _colorsRatio = []) {
        ...
        if (_colorsRatio.length == 0) {
            _colorsRatio = this.arrayResize(_colorsRatio, _colorsArr.length, Math.random());
        }
    ...
    p5.Utils.prototype.enableRuler = function () {
        ...
        pxRulerHCanvas.style.height = 20 + "px";
        ...
        rulerInfo.style.background = "rgba(255,255,255,0.5)";
    ...
    function showMousePosition(x, y) {
        ...
        rulerLineY.style.top = 20 + "px";
        rulerLineY.style.boxShadow = "0px 0px 5px rgba(0,0,0,0.7)";

        // Show ruler info text
        if (x + 70 < width) {
            rulerInfo.style.left = x + 30 + "px";
        }

        if (y + 70 < height) {
            rulerInfo.style.top = y + 40 + "px";
        }
