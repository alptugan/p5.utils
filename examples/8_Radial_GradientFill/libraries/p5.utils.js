(function (root, factory) {
     ...
     * @param {Number} min Floor value of the random number
     * @param {Number} max Ceil value of the random number
     * @returns {Number} Result will be integer
     */
    p5.Utils.prototype.getRandomInt = function (min, max) {
        min = Math.ceil(min);
        max = Math.floor(max);
    ...
    /**
     * @method endShadow
     * @description Stops shadow effect for the following graphics on the canvas. For example usage check {@link_beginShadow} page.
     * 
     * @see {@link_beginShadow}
     * 
     */
     ...
     * @param {Number} _rOuter Radius of the outer radiant gradient space
    ...
    */
    ...
    /**
     * @method setRulerStyle Customize the pixel ruler style. Set the colors and font options. Also customizes the {@link debug} background and text colors.
     ...
     * }
     */
    p5.Utils.prototype.setRulerStyle = function (
        _p5rulerBgColor = "rgba(30,30,30,1)",
        _p5rulerTxtColor = "rgba(150,150,150,1)",
        _p5rulersize = 20,
        _p5rulerInfoColor = "rgba(30,30,30,1)",
        _p5rulerInfoBgColor = "rgba(255,255,255,0.5)",
        _p5rulerTickColor = "rgba(255,0,0,1)",
        _p5rulerFont = "11px monospace"
    ) {
